      ...
      <ReactCarousel
        ...
        renderArrowPrev={(clickHandler, hasPrev) => (
          <button
            ...
            disabled={!hasPrev}
            className="btn absolute top-[calc(100%+5.6rem)] right-[52.5%] z-10 flex h-[6.4rem] w-[6.4rem] cursor-pointer items-center justify-center rounded-full border-none bg-deepBlack hover:border-none hover:bg-purple"
          >
            <ArrowLeftIcon />
          </button>
        )}
        renderArrowNext={(clickHandler, hasNext) => (
          <button
            onClick={clickHandler}
            disabled={!hasNext}
            className="btn absolute top-[calc(100%+5.6rem)] left-[52.5%] flex h-[6.4rem] w-[6.4rem] cursor-pointer items-center justify-center rounded-full border-none bg-deepBlack hover:border-none hover:bg-purple"
          >
            <ArrowRightIcon />
          </button>
        )}
